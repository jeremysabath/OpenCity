...
@interface OpenNowViewController : UITableViewController <UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, MFMailComposeViewControllerDelegate, CLLocationManagerDelegate, MyCLControllerDelegate>{
